...
- **`OperatorCard`** (core and Signature) — portraits that fail to load now fall back
  to the diamond placeholder / operator initials instead of a broken-image icon
...
[Unreleased]: https://github.com/VBeatDead/ReEnd-Components/compare/v1.2.2...HEAD
[1.2.2]: https://github.com/VBeatDead/ReEnd-Components/compare/v1.2.1...v1.2.2
